...
import {
    ...
    getRooms, addRoom, deleteRoom, savePrices,
...
export const AdminPage = ({ onBack }: AdminPageProps) => {
    ...
    return (
        <div className="min-h-screen bg-[#0D0D0D] text-white">
                ...
                <div className="px-4 md:px-12 lg:px-20 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold transition-all ${settings.rooms_full
                        ...
                        <button
                            ...
                            className="w-10 h-10 bg-[#3D1C00] rounded-xl flex items-center justify-center hover:bg-[#5C2A00] transition-colors"
                            title="Logout"
                        >
                            <LogOut size={18} className="text-[#F59820]" />
                        </button>
            ...
            {/* Loading */}
            {loading && (
                <div className="flex items-center justify-center py-20 text-[#7A5230]">
                        ...
                        <div className="animate-fadeUp">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-sm text-[#7A5230]">Edit room prices — saved to the database</p>
                                </div>
                            ...
                            <h3 className="text-xs font-bold text-[#7A5230] uppercase tracking-wider mb-3">All Rooms</h3>
