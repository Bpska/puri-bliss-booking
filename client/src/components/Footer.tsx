...
export const Footer = ({ setPage }: FooterProps = {}) => (
    <footer style={{ background: 'linear-gradient(180deg, #1A0A00 0%, #0D0500 100%)' }} className="mt-6">
        ...
        <div className="px-5 pt-8 pb-4 md:px-12 lg:px-20 md:pt-12 md:pb-8">
            ...
            <div className="md:grid md:grid-cols-3 md:gap-8">
                ...
                <div className="mb-6 text-center md:text-left md:col-span-1">
                    ...
                    <div className="mt-5 space-y-2 text-center md:text-left">
                        ...
                        <div className="inline-flex items-center gap-2 bg-[#D4A017]/10 border border-[#D4A017]/30 px-3 py-1.5 rounded-full mt-2">
                            <span className="text-[#D4A017] text-[10px] font-bold uppercase tracking-widest shrink-0">Food License</span>
                            <span className="text-white text-xs font-semibold">{HOTEL_INFO.foodLicense}</span>
                        </div>
                    </div>
                </div>
            ...
            {/* Google Maps Embed */}
            <div className="md:px-20 mb-8 mt-6">
