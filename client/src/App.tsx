  ...
  return (
    <div className="w-full max-w-[430px] md:max-w-full mx-auto min-h-screen bg-[#FFFCF7] shadow-2xl md:shadow-none overflow-hidden relative flex flex-col">
      ...
      <a
        ...
        className="fixed right-3 bottom-36 md:bottom-24 md:right-6 z-50 w-11 h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-full flex items-center justify-center shadow-xl hover:scale-110 active:scale-95 transition-transform"
        title="Call Now"
